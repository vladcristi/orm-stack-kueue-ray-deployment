...
variable "deploy_kueue" {
  type        = bool
  default     = true
  description = "Controls the deployment of the Kueue helm chart."
}

variable "kueue_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the Kueue helm chart defaults and those generated by Terraform using the templates."
}

variable "deploy_kuberay_operator" {
  type        = bool
  default     = true
  description = "Controls the deployment of the Kuberay Operator helm chart."
}

variable "kuberay_operator_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the Kuberay Operator helm chart defaults and those generated by Terraform using the templates."
}